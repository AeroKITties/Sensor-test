...
#define MS5611_EN HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, GPIO_PIN_RESET);
#define MS5611_DIS HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, GPIO_PIN_SET);
...
static void ms5611_init()
{
	...
	// prom[1] = 65536L;          //  SENSt1
    // prom[2] = 131072L;         //  OFFt1
    // prom[3] = 7.8125E-3;       //  TCS
    // prom[4] = 1.5625e-2;       //  TCO
}
